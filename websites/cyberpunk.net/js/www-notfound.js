...
*/
  ...
  function da(a, b) {
    if (b)
      a: {
        for (var c = ca, e = a.split('.'), d = 0; d < e.length - 1; d++) {
          var f = e[d];
          if (!(f in c)) break a;
          c = c[f];
        }
        ...
        f != d &&
          null != f &&
          aa(c, e, { configurable: !0, writable: !0, value: f });
      }
  }
  var ea =
  ...
  function ha(a) {
    (Object.prototype.hasOwnProperty.call(a, r) && a[r]) || (a[r] = ++ia);
  }
  ...
  function u(a, b) {
    ...
    c[0] in e ||
      ...
      e.execScript('var ' + c[0]);
    for (var d; c.length && (d = c.shift()); )
      c.length || void 0 === b
        ? e[d] && e[d] !== Object.prototype[d]
          ? (e = e[d])
          : (e = e[d] = {})
        : (e[d] = b);
  }
  ...
  var oa = /^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i,
    ...
    G = {};
  function pa(a, b) {
    if (b instanceof C && b.constructor === C && b.g === E) var c = b.f;
    else q(b), (c = 'type_error:TrustedResourceUrl');
    a.src = c;
    (c = a.ownerDocument && a.ownerDocument.defaultView) && c != g
      ? (c = l(c.document))
      : (null === h && (h = l(g.document)), (c = h));
  ...
  function ta() {
    if (g.Promise && g.Promise.resolve) {
      ...
      N = function() {
        var b = Q,
          c;
        !(c = 'function' != q(g.setImmediate)) &&
          (c = g.Window && g.Window.prototype) &&
          (c =
            -1 == y.indexOf('Edge') &&
            g.Window.prototype.setImmediate == g.setImmediate);
        c ? (J || (J = ra()), J(b)) : g.setImmediate(b);
      };
  }
  var O = !1,
    P = new K();
  function Q() {
    for (var a; (a = P.remove()); ) {
      try {
        a.a.call(a.b);
      } catch (c) {
        qa(c);
  ...
  S.prototype.l = function(a) {
    ...
    if (b) {
      var c = this.b[b];
      if (0 != this.i) this.h.push(a), (this.a[a + 1] = p);
      else {
        if (c) {
          var e = na(c, a);
          0 <= e && Array.prototype.splice.call(c, e, 1);
        }
        delete this.a[a];
        delete this.a[a + 1];
        delete this.a[a + 2];
  ...
  S.prototype.u = function(a, b) {
    ...
    if (c) {
      for (
        var e = Array(arguments.length - 1), d = 1, f = arguments.length;
        d < f;
        d++
      )
        e[d - 1] = arguments[d];
      if (this.s)
        for (d = 0; d < c.length; d++) {
          var k = c[d];
          wa(this.a[k + 1], this.a[k + 2], e);
        }
      else {
        this.i++;
        try {
          for (d = 0, f = c.length; d < f; d++)
            (k = c[d]), this.a[k + 1].apply(this.a[k + 2], e);
        } finally {
  ...
  S.prototype.clear = function(a) {
    if (a) {
      var b = this.b[a];
      b && (w(b, this.l, this), delete this.b[a]);
  ...
  function U(a) {
    var b = arguments;
    1 < b.length ? (T[b[0]] = b[1]) : 1 === b.length && Object.assign(T, b[0]);
  }
  function W(a, b) {
    return a in T ? T[a] : b;
  }
  ...
  function ya() {
    return (
      za.loaded ||
      (za.loaded = 'loaded'.replace(/\-([a-z])/g, function(a, b) {
  ...
  var Fa = g.ytPubsubPubsubInstance || new S();
  S.prototype.subscribe = S.prototype.subscribe;
  S.prototype.unsubscribeByKey = S.prototype.l;
  S.prototype.publish = S.prototype.u;
  S.prototype.clear = S.prototype.clear;
  u('ytPubsubPubsubInstance', Fa);
  var X = g.ytPubsubPubsubSubscribedKeys || {};
  u('ytPubsubPubsubSubscribedKeys', X);
  var Y = g.ytPubsubPubsubTopicToKeys || {};
  u('ytPubsubPubsubTopicToKeys', Y);
  var Ga = g.ytPubsubPubsubIsSynchronous || {};
  ...
  var La = /\.vflset|-vfl[a-zA-Z0-9_+=-]+/,
    Ma = /-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;
  function Na(a, b) {
            ...
            function() {
              if (!xa(d)) {
                ...
                m &&
                  (m.dataset
                    ? (m.dataset[ya()] = 'true')
                    : m.setAttribute('data-loaded', 'true'));
                Ia(e);
                Ea(la(Ja, e));
              }
            },
  ...
  function Pa(a) {
    ...
    a instanceof F ||
      ...
      oa.test(a) || (a = 'about:invalid#zClosurez'),
      (a = new F(G, a)));
    a instanceof F && a.constructor === F && a.g === H
      ? (a = a.f)
      : (q(a), (a = 'type_error:SafeUrl'));
    b.href = a;
  ...
  u('yt.setConfig', U);
  u('yt.config.set', U);
  u('yt.www.notfound.init', function() {
    var a = W('SBOX_JS_URL', void 0);
    a &&
      Na(a, function() {
        try {
          n('yt.www.masthead.searchbox.init')();
        } catch (b) {
          throw ((b.message += ' SboxUrl: "' + a + '"'), b);
        }
      });
  });
}.call(this));
