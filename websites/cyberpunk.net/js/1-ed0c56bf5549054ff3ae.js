    ...
    QdZy: function(e, t, s) {
            ...
            if (l.indexOf('<') >= 0 && l.indexOf('>') >= 0) {
              ...
              for (
                0 === l.indexOf('<li') && (e = 'ul'),
                  ...
                  (n = i.createElement(e)).innerHTML = l,
                  r = 0;
      ...
      const o = {
          ...
          for (let n = 0; n < t.length; n += 1) {
            ...
            for (let t = 0; t < this.length; t += 1) {
              ...
              try {
                ...
                (l = i.createEvent('Event')).initEvent(r, !0, !0),
                  (l.detail = s);
              }
        ...
        offset: function() {
          if (this.length > 0) {
            ...
            return { top: t.top + l - n, left: t.left + o - r };
          }
          return null;
        },
        css: function(e, t) {
      ...
      var u = {
        ...
        updateSlides: function() {
          ...
          for (let s = 0; s < u; s += 1) {
              ...
              if (
                ...
                if ('column' === t.slidesPerColumnFill)
                  ...
                  a =
                    s -
                    (r =
                      Math.floor(s / t.slidesPerView) - e * t.slidesPerColumn) *
                      t.slidesPerView -
                    e * t.slidesPerView;
                }
                (i = a + (r * y) / M),
            ...
            if ('none' !== n.css('display')) {
              if ('auto' === t.slidesPerView) {
                ...
                (T = (i - (t.slidesPerView - 1) * E) / t.slidesPerView),
                  t.roundLengths && (T = Math.floor(T)),
                  h[s] &&
                    (e.isHorizontal()
                      ? (h[s].style.width = `${T}px`)
                      : (h[s].style.height = `${T}px`));
              h[s] && (h[s].swiperSlideSize = T),
                f.push(T),
                t.centeredSlides
                  ? ((S = S + T / 2 + C / 2 + E),
                    0 === C && 0 !== s && (S = S - i / 2 - E),
          ...
          if (
            ...
            t.slidesPerColumn > 1 &&
              ((e.virtualSize = (T + t.spaceBetween) * y),
              (e.virtualSize =
            ...
            for (let s = 0; s < m.length; s += 1) {
              ...
              t.roundLengths && (i = Math.floor(i)),
                m[s] < e.virtualSize + m[0] && z.push(i);
            }
            m = z;
          }
          if (!t.centeredSlides) {
            ...
            for (let s = 0; s < m.length; s += 1) {
              ...
              t.roundLengths && (a = Math.floor(a)),
                m[s] <= e.virtualSize - i && z.push(a);
            }
            (m = z),
              Math.floor(e.virtualSize - i) - Math.floor(m[m.length - 1]) > 1 &&
                m.push(e.virtualSize - i);
          }
          if (
            (0 === m.length && (m = [0]),
            0 !== t.spaceBetween &&
              (e.isHorizontal()
                ? n
                  ? h.css({ marginLeft: `${E}px` })
                  : h.css({ marginRight: `${E}px` })
                : h.css({ marginBottom: `${E}px` })),
        ...
        updateActiveIndex: function(e) {
          ...
          if (
            ((p =
              a.indexOf(s) >= 0
                ? a.indexOf(s)
                : Math.floor(c / n.slidesPerGroup)) >= a.length &&
              (p = a.length - 1),
            c === r)
          )
            return void (
      ...
      var m = {
        ...
        setTranslate: function(e, t) {
          ...
          s.isHorizontal() ? (o = i ? -e : e) : (d = e),
            ...
            a.virtualTranslate ||
              (p.transforms3d
                ? n.transform(`translate3d(${o}px, ${d}px, 0px)`)
                : n.transform(`translate(${o}px, ${d}px)`)),
            (s.previousTranslate = s.translate),
            (s.translate = s.isHorizontal() ? o : d);
          const c = s.maxTranslate() - s.minTranslate();
          (l = 0 === c ? 0 : (e - s.minTranslate()) / c) !== r &&
            s.updateProgress(e),
      ...
      var f = {
          ...
          return (
            ...
            (h && -m === a.translate) || (!h && m === a.translate)
              ? (a.updateActiveIndex(n),
                ...
                'reset' !== g &&
                  (a.transitionStart(s, g), a.transitionEnd(s, g)),
                !1)
              : (0 !== t && p.transition
                  ? (a.setTransition(t),
                    a.setTranslate(m),
        ...
        slidePrev: function(e = this.params.speed, t = !0, s) {
          ...
          const p = d(o ? i.translate : -i.translate),
            c = r.map(e => d(e)),
            h = (l.map(e => d(e)), r[c.indexOf(p)], r[c.indexOf(p) - 1]);
          let u;
          return (
      ...
      var v = {
        loopCreate: function() {
          ...
          for (let e = 0; e < l.length; e += 1)
            s.append(r(l[e].cloneNode(!0)).addClass(t.slideDuplicateClass));
      ...
      var w = {
        ...
        prependSlide: function(e) {
          ...
          s.loop && t.loopCreate(),
            (s.observer && p.observer) || t.update(),
            t.slideTo(n, 0, !1);
        },
        addSlide: function(e, t) {
          ...
          a.loop && s.loopCreate(),
            (a.observer && p.observer) || s.update(),
      ...
      const x = (function() {
        ...
        if (
          ...
          (r || o || l) && ((t.os = 'ios'), (t.ios = !0)),
          o && !l && ((t.osVersion = o[2].replace(/_/g, '.')), (t.iphone = !0)),
          r && ((t.osVersion = r[2].replace(/_/g, '.')), (t.ipad = !0)),
          l &&
            ((t.osVersion = l[3] ? l[3].replace(/_/g, '.') : null),
            (t.iphone = !0)),
          t.ios &&
            t.osVersion &&
            e.indexOf('Version/') >= 0 &&
          ...
          (t.webView = (o || r || l) && e.match(/.*AppleWebKit(?!.*Safari)/i)),
          t.os && 'ios' === t.os)
        ) {
            ...
            attachEvents: function() {
              ...
              (e.onTouchStart = function(e) {
                ...
                if (!h || !(p <= u || p >= a.screen.width - u)) {
                  if (
                    ...
                    let e = !0;
                    r(o.target).is(s.formElements) && (e = !1),
                      i.activeElement &&
                        r(i.activeElement).is(s.formElements) &&
                        i.activeElement !== o.target &&
                ...
                (e.onTouchMove = function(e) {
                  const t = this,
                    s = t.touchEventsData,
                    { params: a, touches: n, rtlTranslate: l } = t;
                  let o = e;
                  ...
                  if (s.isTouchEvent && a.touchReleaseOnEdges && !a.loop)
                    if (t.isVertical()) {
                      ...
                      (p < n.startX && t.translate <= t.maxTranslate()) ||
                      (p > n.startX && t.translate >= t.minTranslate())
                    )
                      return;
                  if (
                    s.isTouchEvent &&
                      ...
                      ? ((g = !1),
                        a.resistance &&
                          (s.currentTranslate =
                            t.minTranslate() -
                            1 +
                            (-t.minTranslate() + s.startTranslate + m) ** f))
                      : m < 0 &&
                        ...
                        a.resistance &&
                          (s.currentTranslate =
                            t.maxTranslate() +
                            1 -
                            (t.maxTranslate() - s.startTranslate - m) ** f)),
                ...
                (e.onTouchEnd = function(e) {
                  ...
                  for (let e = 0; e < l.length; e += i.slidesPerGroup)
                    void 0 !== l[e + i.slidesPerGroup]
                      ? u >= l[e] &&
                        u < l[e + i.slidesPerGroup] &&
                        ((m = e), (g = l[e + i.slidesPerGroup] - l[e]))
                      : u >= l[e] &&
                        ((m = e), (g = l[l.length - 1] - l[l.length - 2]));
                  const f = (u - l[m]) / g;
                  if (h > i.longSwipesMs) {
              ...
              if (p.touch || (!p.pointerEvents && !p.prefixedPointerEvents)) {
                if (p.touch) {
                  ...
                  o.addEventListener(s.start, e.onTouchStart, i),
                    o.addEventListener(
                      s.move,
                      e.onTouchMove,
                      p.passiveListener ? { passive: !1, capture: c } : c
                    ),
                    o.addEventListener(s.end, e.onTouchEnd, i);
                }
                ((t.simulateTouch && !x.ios && !x.android) ||
                  (t.simulateTouch && !p.touch && x.ios)) &&
                  (o.addEventListener('mousedown', e.onTouchStart, !1),
                  i.addEventListener('mousemove', e.onTouchMove, c),
                  i.addEventListener('mouseup', e.onTouchEnd, !1));
              } else
                o.addEventListener(s.start, e.onTouchStart, !1),
                  i.addEventListener(s.move, e.onTouchMove, c),
            ...
            setBreakpoint: function() {
              ...
              if (r && e.currentBreakpoint !== r) {
                ...
                const o = l || e.originalParams,
                  p = o.direction && o.direction !== a.direction,
                  c = a.loop && (o.slidesPerView !== a.slidesPerView || p);
            ...
            d.extend(i, {
              ...
              touchEvents: (function() {
                ...
                return (
                  ...
                  p.touch || !i.params.simulateTouch
                    ? i.touchEventsTouch
                    : i.touchEventsDesktop
                );
              })(),
        ...
        changeDirection(e, t = !0) {
          ...
          return (
            ...
            e === i || ('horizontal' !== e && 'vertical' !== e)
              ...
              : (s.$el
                  .removeClass(
                    `${s.params.containerModifierClass}${i} wp8-${i}`
                  )
      ...
      var $ = { name: 'device', proto: { device: x }, static: { device: x } },
        M = { name: 'support', proto: { support: p }, static: { support: p } },
      ...
      const L = {
        update(e) {
          ...
          if (
            ...
            return (
              t.slidesGrid !== c && x !== u && t.slides.css(g, `${x}px`),
        ...
        update() {
          ...
          if (
            ('fraction' === s.type &&
              ...
              a.find(`.${s.totalClass}`).text(s.formatFractionTotal(l))),
            'progressbar' === s.type)
          ) {
            let t;
      ...
      const B = {
        ...
        setDragPosition(e) {
          const { scrollbar: t, rtlTranslate: s } = this,
            { $el: i, dragSize: a, trackSize: n, dragStartPos: r } = t;
          let l;
          (l =
        ...
        enableDraggable() {
          ...
          p.touch
            ...
            : (r.addEventListener(a.start, e.scrollbar.onDragStart, l),
              i.addEventListener(a.move, e.scrollbar.onDragMove, l),
              i.addEventListener(a.end, e.scrollbar.onDragEnd, o));
        },
        disableDraggable() {
          const e = this;
          if (!e.params.scrollbar.el) return;
          ...
          p.touch
            ...
            : (r.removeEventListener(a.start, e.scrollbar.onDragStart, l),
              i.removeEventListener(a.move, e.scrollbar.onDragMove, l),
              i.removeEventListener(a.end, e.scrollbar.onDragEnd, o));
        },
        init() {
          const e = this;
          if (!e.params.scrollbar.el) return;
      ...
      const V = {
        ...
        onTouchEnd() {
          ...
          const r = i.x * a,
            ...
            o = i.y * n,
            d = s.currentY + o;
          0 !== i.x && (a = Math.abs((l - s.currentX) / i.x)),
            0 !== i.y && (n = Math.abs((d - s.currentY) / i.y));
          const p = Math.max(a, n);
        ...
        in(e) {
          ...
          if (
            ...
            return;
          let l, o, d, p, c, h, u, m, g, f, v, b, w, x, y, T, E, S;
          a.$slideEl.addClass(`${i.zoomedSlideClass}`),
            ...
            e
              ? ((E = a.$slideEl[0].offsetWidth),
                ...
                (c = (d = a.$slideEl.offset().left) + E / 2 - l),
                (h = (p = a.$slideEl.offset().top) + S / 2 - o),
                (g = a.$imageEl[0].offsetWidth),
                (f = a.$imageEl[0].offsetHeight),
                (v = g * s.scale),
                (b = f * s.scale),
                (y = -(w = Math.min(E / 2 - v / 2, 0))),
                (T = -(x = Math.min(S / 2 - b / 2, 0))),
                (u = c * s.scale) < w && (u = w),
                u > y && (u = y),
                (m = h * s.scale) < x && (m = x),
                m > T && (m = T))
            ...
            a.$imageWrapEl
              .transition(300)
              .transform(`translate3d(${u}px, ${m}px,0)`),
            a.$imageEl
              .transition(300)
              .transform(`translate3d(0,0,0) scale(${s.scale})`);
        },
      ...
      const q = {
        ...
        setHistory(e, t) {
          ...
          let i = q.slugify(s.attr('data-history'));
      ...
      const K = {
        setTranslate() {
          ...
          o.shadow &&
            (d
              ? (0 === (h = t.find('.swiper-cube-shadow')).length &&
                  ((h = r('<div class="swiper-cube-shadow"></div>')),
                  t.append(h)),
                h.css({ height: `${i}px` }))
              : 0 === (h = e.find('.swiper-cube-shadow')).length &&
                ((h = r('<div class="swiper-cube-shadow"></div>')),
                e.append(h)));
          ...
          const m = c.isSafari || c.isUiWebView ? -l / 2 : 0;
          t.transform(
