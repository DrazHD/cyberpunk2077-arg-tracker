      ...
      var u = {
        ...
        updateSlides: function() {
            ...
            if ('none' !== n.css('display')) {
              if ('auto' === t.slidesPerView) {
                ...
                if (
                  ...
                  y = r && 'border-box' === r ? e + a + n : e + t + i + a + n;
                } else {
                ...
                (y = (i - (t.slidesPerView - 1) * T) / t.slidesPerView),
                  t.roundLengths && (y = Math.floor(y)),
                  c[s] &&
                    (e.isHorizontal()
                      ? (c[s].style.width = `${y}px`)
                      : (c[s].style.height = `${y}px`));
              c[s] && (c[s].swiperSlideSize = y),
                f.push(y),
                t.centeredSlides
                  ? ((E = E + y / 2 + S / 2 + T),
                    0 === S && 0 !== s && (E = E - i / 2 - T),
          ...
          if (
            ...
            t.slidesPerColumn > 1 &&
              ((e.virtualSize = (y + t.spaceBetween) * x),
              (e.virtualSize =
            ...
            for (let s = 0; s < u.length; s += 1) {
              ...
              t.roundLengths && (i = Math.floor(i)),
                u[s] < e.virtualSize + u[0] && k.push(i);
            }
            u = k;
          }
          if (!t.centeredSlides) {
          ...
          if (
            ...
            0 !== t.spaceBetween &&
              (e.isHorizontal()
                ? n
                  ? c.css({ marginLeft: `${T}px` })
                  : c.css({ marginRight: `${T}px` })
                : c.css({ marginBottom: `${T}px` })),
                  ...
                  for (let e = 0; e < l.length; e += i.slidesPerGroup)
                    void 0 !== l[e + i.slidesPerGroup]
                      ? u >= l[e] &&
                        ...
                        ((m = e), (f = l[e + i.slidesPerGroup] - l[e]))
                      : u >= l[e] &&
          ...
          return (
            ...
            e === i || ('horizontal' !== e && 'vertical' !== e)
              ...
              : ('vertical' === i &&
                  (s.$el
                    .removeClass(
                      `${s.params.containerModifierClass}vertical wp8-vertical`
                    )
                    .addClass(`${s.params.containerModifierClass}${e}`),
                  (c.isIE || c.isEdge) &&
                    (p.pointerEvents || p.prefixedPointerEvents) &&
                    s.$el.addClass(
                      `${s.params.containerModifierClass}wp8-${e}`
                    )),
                'horizontal' === i &&
                  (s.$el
                    .removeClass(
                      `${s.params.containerModifierClass}horizontal wp8-horizontal`
                    )
                    .addClass(`${s.params.containerModifierClass}${e}`),
                  (c.isIE || c.isEdge) &&
                    (p.pointerEvents || p.prefixedPointerEvents) &&
      ...
      const I = {
        update(e) {
          ...
          if (
            ...
            return (
              t.slidesGrid !== c && x !== u && t.slides.css(f, `${x}px`),
      ...
      const Y = {
        ...
        in(e) {
          ...
          if (
            ...
            return;
          let l, o, d, p, c, h, u, m, f, g, v, b, w, x, y, T, E, S;
      ...
      const Z = {
        setTranslate() {
          ...
          for (let e = 0, t = s.length; e < t; e += 1) {
            ...
            const v = `translate3d(${g}px,${f}px,${m}px)  rotateX(${u}deg) rotateY(${p}deg)`;
            if (
              (t.transform(v),
