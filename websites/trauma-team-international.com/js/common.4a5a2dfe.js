      ...
      !(function(t, n) {
        ...
        function T(e, t, n, r) {
          var i,
            ...
            c =
              (ke.cssNumber[t] || ('px' !== l && +u)) && Ge.exec(ke.css(e, t));
          if (c && c[3] !== l) {
        ...
        function P(e, t) {
          ...
          if (1 === t.nodeType) {
            if (
              _e.hasData(e) &&
              ((o = _e.access(e)), (a = _e.set(t, o)), (l = o.events))
            ) {
            ...
            ze.hasData(e) &&
              ((s = ze.access(e)), (u = ke.extend({}, s)), ze.set(t, u));
          }
        }
        function M(e, t) {
        ...
        function R(e, t, n, r) {
          ...
          if (
            g ||
            (p > 1 && 'string' == typeof h && !we.checkClone && ct.test(h))
          )
          ...
          if (
            ...
            for (s = ke.map(k(i, 'script'), H), u = s.length; f < p; f++)
              (l = i),
                f !== d &&
                  ((l = ke.clone(l, !0, !0)), u && ke.merge(s, k(l, 'script'))),
                n.call(e[f], l, f);
            if (u)
              for (
        ...
        function X(e, t, n) {
          ...
          return (
            ...
            ('auto' === i ||
              (!parseFloat(i) && 'inline' === ke.css(e, 'display', !1, r))) &&
              ((i = e['offset' + t[0].toUpperCase() + t.slice(1)]), (a = !0)),
            (i = parseFloat(i) || 0) +
              z(e, t, n || (o ? 'border' : 'content'), a, r, i) +
              'px'
          );
        }
            ...
            for (r in d)
              u ||
                (v
                  ...
                  : (v = _e.access(e, 'fxshow', { display: l })),
                o && (v.hidden = !g),
                g && E([e], !0),
                p.done(function() {
        ...
        function Z(e, t, n) {
          ...
          for (K(c, l.opts.specialEasing); o < a; o++)
            if ((r = Z.prefilters[o].call(l, e, c, l.opts)))
              return (
                Te(r.stop) &&
                  (ke._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)),
                r
              );
          return (
            ke.map(c, Q, l),
        ...
        (ke.fn = ke.prototype = {
          ...
          'function' == typeof Symbol &&
            (ke.fn[Symbol.iterator] = le[Symbol.iterator]),
          ke.each(
         ...
         */ = (function(e) {
          function t(e, t, n, r) {
            ...
            if (
              !r &&
              ((t ? t.ownerDocument || t : W) !== q && j(t), (t = t || q), H)
            ) {
              if (11 !== h && (u = ge.exec(e)))
                if ((i = u[1])) {
                  if (9 === h) {
          ...
          function y(e) {
            for (
              ...
              if ((n = w.relative[e[s].type])) c = [p(d(c), n)];
                ...
                if (
                  ((n = w.filter[e[s].type].apply(null, e[s].matches)), n[I])
                ) {
            ...
            var i = n.length > 0,
              ...
              a = function(r, a, s, u, l) {
                ...
                for (
                  ...
                  if (o && c) {
                    for (
                      f = 0, a || c.ownerDocument === q || (j(c), (s = !H));
                      (p = e[f++]);
        ...
        (ke.find = Ne),
          ...
          (ke.uniqueSort = ke.unique = Ne.uniqueSort),
          (ke.text = Ne.getText),
          (ke.isXMLDoc = Ne.isXML),
          (ke.contains = Ne.contains),
          (ke.escapeSelector = Ne.escape);
        ...
        (ke.filter = function(e, t, n) {
          ...
          ke.fn.extend({
            ...
            is: function(e) {
              return !!c(
                this,
                'string' == typeof e && je.test(e) ? ke(e) : e || [],
                !1
              ).length;
            }
          });
            ...
            function(e, t) {
              ke.fn[e] = function(n, r) {
                ...
                return (
                  ...
                  this.length > 1 &&
                    (Pe[e] || ke.uniqueSort(i), Oe.test(e) && i.reverse()),
                  this.pushStack(i)
                );
              };
            }
        ...
        (ke.fn.ready = function(e) {
          ...
          ke.extend({
            ...
            ready: function(e) {
              (!0 === e ? --ke.readyWait : ke.isReady) ||
                ((ke.isReady = !0),
                (!0 !== e && --ke.readyWait > 0) || Ie.resolveWith(ce, [ke]));
            }
          }),
          ...
          ('loading' !== ce.readyState && !ce.documentElement.doScroll)
            ...
            : (ce.addEventListener('DOMContentLoaded', v),
            ...
            queue: function(e, t, n) {
              ...
              if (e)
                return (
                  ...
                  n &&
                    (!r || Array.isArray(n)
                      ? (r = _e.access(e, t, ke.makeArray(n)))
                      : r.push(n)),
                  r || []
                );
            },
        ...
        ke.extend({
          ...
          clone: function(e, t, n) {
            ...
            if (
              ...
              for (a = k(s), o = k(e), r = 0, i = o.length; r < i; r++)
                M(o[r], a[r]);
            if (t)
              if (n)
                for (
                  o = o || k(e), a = a || k(s), r = 0, i = o.length;
                  r < i;
                  r++
                )
                  P(o[r], a[r]);
          ...
          ke.fn.extend({
            ...
            empty: function() {
              for (var e, t = 0; null != (e = this[t]); t++)
                1 === e.nodeType &&
                  (ke.cleanData(k(e, !1)), (e.textContent = ''));
              return this;
            },
            clone: function(e, t) {
              return (
          ...
          val: function(e) {
              ...
              i = this[0];
            {
              ...
              if (i)
                return (t =
                  ke.valHooks[i.type] ||
                  ke.valHooks[i.nodeName.toLowerCase()]) &&
                  'get' in t &&
        ...
        ke.extend(ke.event, {
          trigger: function(e, t, r, i) {
            ...
            if (
              ...
              3 !== r.nodeType &&
                8 !== r.nodeType &&
                !jt.test(h + ke.event.triggered) &&
                (h.indexOf('.') > -1 &&
                  ((g = h.split('.')), (h = g.shift()), g.sort()),
                (l = h.indexOf(':') < 0 && 'on' + h),
                (e = e[ke.expando]
                  ? e
                  : new ke.Event(h, 'object' == typeof e && e)),
                (e.isTrigger = i ? 2 : 3),
                (e.namespace = g.join('.')),
              ...
              for (o = 0; (a = d[o++]) && !e.isPropagationStopped(); )
                (p = a),
                  ...
                  (c =
                    (_e.get(a, 'events') || {})[e.type] && _e.get(a, 'handle')),
                  c && c.apply(a, t),
                  (c = l && a[l]) &&
                    c.apply &&
                    Fe(a) &&
            ...
            ke.each({ focus: 'focusin', blur: 'focusout' }, function(e, t) {
              ...
              ke.event.special[t] = {
                ...
                teardown: function() {
                  ...
                  i
                    ? _e.access(r, t, i)
                    : (r.removeEventListener(e, n, !0), _e.remove(r, t));
                }
              };
            });
        var Lt = n.location,
        ...
        ke.ajaxSetup({
          ...
          ke.ajaxPrefilter('json jsonp', function(e, t, r) {
            ...
            if (s || 'jsonp' === e.dataTypes[0])
              return (
                (i = e.jsonpCallback = Te(e.jsonpCallback)
                  ? e.jsonpCallback()
                  : e.jsonpCallback),
                s
          ...
          ke.each(['top', 'left'], function(e, t) {
            ke.cssHooks[t] = $(we.pixelPosition, function(e, n) {
              if (n)
                return (
                  (n = W(e, t)), pt.test(n) ? ke(e).position()[t] + 'px' : n
                );
            });
          }),
