  ...
  ['app'],
  {
        ...
        return (
          ...
          c(e).forEach(function(i) {
            ...
            (a = p(s)).length > 0 &&
              ...
              r.changeFontFaceRuleSrc(e, i, o.serialize(s)),
              (m = !0));
          }),
          h(e).forEach(function(i) {
            var s = i.href,
              o = n.joinUrl(t, s);
            r.exchangeRule(e, i, '@import url(' + o + ');'), (m = !0);
          }),
          m
        );
      };
        ...
        return Promise.all(
          o.map(function(o) {
            return (function(t, i, s, o) {
              ...
              return (
                (l = r.unquoteString(l)),
                (a = n.joinUrl(o.baseUrl, l)),
                s.indexOf(a) >= 0
                  ? (d(t, i, []), Promise.resolve([]))
                  : (s.push(a),
                    n.ajax(l, o).then(
                      function(n) {
                        var a = r.rulesForCssText(n);
                        return e
                          .loadCSSImportsForRules(a, s, o)
                          .then(function(n) {
                            return (
                              e.adjustPathsOfCssResources(l, a),
                              d(t, i, a),
                              n.errors
                            );
                          });
          ...
          return Promise.all(
            r.map(function(t) {
              return (function(t, e) {
                ...
                e.hasChanges &&
                  (a(t.rule, t.property, e.backgroundValue), (c = !0)),
                  (o = o.concat(e.errors));
              });
            })
          ).then(function() {
            return { hasChanges: c, errors: o };
          });
        },
        _ = function(t, e) {
          var i = c(t),
              ...
              return (function(t, e) {
                ...
                return (
                  ...
                  n
                    ...
                    .then(function(t) {
                      return {
                        srcDeclarationValue: o.serialize(i),
                        hasChanges: s,
                        errors: t
                      };
                    })
                  ...
                  l.map(function(e, i) {
                    ...
                    (n = t(i)
                      ...
                      (o =
                        ...
                        r +
                        '</span></div>'),
                      s.a.drawHTML(o).then(function(t) {
    ...
    CxY0: function(t, e, i) {
      ...
      (s.prototype.parse = function(t, e, i) {
        ...
        (s.prototype.resolveObject = function(t) {
          ...
          for (
            var i = new s(), n = Object.keys(this), o = 0;
            o < n.length;
            o++
          ) {
            var a = n[o];
          ...
          var e,
            ...
            o =
              ...
              Array.prototype.map
                ...
                .join(''));
          for (r = 0; r < n.length; r++) if ((s = n[r].exec(o))) return s[1];
        };
      ...
      (function(t, n) {
        ...
        var r =
          ...
          s = (function(t) {
                  ...
                  if (0 === d && r)
                    for (
                      c = (u = ('com.greensock.' + t).split('.')).pop(),
                        f = h(u.join('.'))[c] = this.gsClass = r.apply(r, o),
                        s && (n[c] = e[c] = f),
                        p = 0;
                      p < this.sc.length;
                      p++
            ...
            ((o = C.prototype).addEventListener = function(t, e, i, n, r) {
              r = r || 0;
              var s,
                o,
                u = this._listeners[t],
            ...
            y('Ticker', function(t, e) {
              ...
              C.call(c),
                ...
                (c.fps = function(t) {
                  ...
                  (o = 1 / ((n = t) || 60)), (u = this.time + o), c.wake();
                }),
                (c.useRAF = function(t) {
              ...
              ((o = f.Ticker.prototype = new f.events.EventDispatcher()).constructor =
                f.Ticker);
            ...
            ((o = E.prototype = new R()).constructor = E),
              (o.kill()._gc = !1),
            ...
            ((o = I.prototype = new R()).constructor = I),
              (o.kill()._gc = !1),
              (o.ratio = 0),
            ...
            var D = [],
              ...
              B = function(t, e, i, n) {
                ...
                for (
                  ...
                  (c = s[a]),
                    (p +=
                      (u = e.substr(f, e.indexOf(c, f) - f)) || !a ? u : ','),
                    (f += u.length),
            ...
            (Z._startTime = a.time),
              ...
              (R._updateRoot = I.render = function() {
                ...
                if (
                  ...
                  for (i in ((G = a.frame + (parseInt(I.autoSleep, 10) || 120)),
                  V)) {
              ...
              (o._initProps = function(e, i, n, r, s) {
                ...
                this.vars))
                  if (((h = this.vars[o]), Y[o]))
                    ...
                    X[o] &&
                    (u = new X[o]())._onInitTween(e, this.vars[o], this, s)
                  ) {
                    for (
                      this._firstPT = c = {
                        _next: this._firstPT,
      ...
      (e.parse = function(t) {
        return (function(t) {
          ...
          if (
            ...
            for (e = r.exec(t); e; ) s.push(o(e[0])), (e = r.exec(t));
            return s;
          }
          return [];
        })(t).map(function(t) {
    ...
    'VR/X': function(t, e, i) {
      ...
      e.inline = function(t, e) {
        var i,
          ...
          o = r(t.getElementsByTagName('image')),
          a =
    ...
    XpGV: function(t, e, i) {
        ...
        return new Promise(function(n, s) {
          ...
          (o = (function(t, e) {
            ...
            a.addEventListener(
              'load',
              function() {
                200 === a.status || 0 === a.status ? n(a.response) : u();
              },
              !1
            ),
            a.addEventListener('error', u, !1);
          try {
            a.open('GET', o, !0), a.overrideMimeType(i.mimeType), a.send(null);
          } catch (t) {
            u();
          }
        });
      ...
      e.memoize = function(t, e, i) {
        ...
        return function() {
          ...
          return i[a] && i[a][s]
            ? i[a][s]
            : ((n = t.apply(null, r)), (i[a] = i[a] || {}), (i[a][s] = n), n);
        };
      };
    },
    YYSD: function(t, e, i) {
      ...
      var n = i('XpGV'),
        ...
        c = function(t, e, i) {
          var n = a.rulesForCssText(t);
          return o.loadCSSImportsForRules(n, e, i).then(function(e) {
            return o.loadAndInlineCSSResourcesForRules(n, i).then(function(i) {
              var r = e.errors.concat(i.errors),
                s = e.hasChanges || i.hasChanges;
              return (
                s && (t = a.cssRulesToText(n)),
      ...
      var h = function(t, e) {
        return n
          .ajax(t, e)
          .then(function(t) {
            return { content: t, cssRules: a.rulesForCssText(t) };
          })
          .then(function(e) {
            var i = o.adjustPathsOfCssResources(t, e.cssRules);
          ...
          .then(function(t) {
            var e = t.content;
            return (
              t.hasChanges && (e = a.cssRulesToText(t.cssRules)),
                  ...
                  open: function(i) {
                    ...
                    if (!1 === i.isObj) {
                      ...
                      for (n = 0; n < a.length; n++)
                        if (
                          ((s = a[n]).parsed && (s = s.el[0]), s === i.el[0])
                        ) {
                          e.index = n;
                          break;
                        }
                    ...
                    proto: {
                        ...
                        if (i.enabled && e.supportsTransition) {
                          ...
                          h('BuildControls' + n, function() {
                            ...
                            h('BeforeClose' + n, function() {
                              if (e._allowZoom()) {
                                if (
                                  (clearTimeout(r), (e.st.removalDelay = o), !t)
                                ) {
                      ...
                      _getOffset: function(i) {
                        ...
                        var a = {
                          width: n.width(),
                          height:
                            (u ? n.innerHeight() : n[0].offsetHeight) - o - s
                        };
                        return (
                          void 0 === C &&
                            (C =
                    ...
                    initGallery: function() {
                      ...
                      (o += ' mfp-gallery'),
                        ...
                        h('MarkupParse' + n, function(t, n, r, s) {
                          ...
                          r.counter = o > 1 ? O(i.tCounter, s.index, o) : '';
                        }),
                        h('BuildControls' + n, function() {
      ...
      (function(t) {
        ...
        var n = function() {
          ...
          (window.onYouTubeIframeAPIReady = function() {
            l() || ('zh-cn' !== document.documentElement.lang && (o = !0));
          }),
        ...
        (r.prototype.fade = function(t, e) {
          ...
          var o = window.setInterval(function() {
            (n = i ? n + r : n - r),
              ...
              (n <= 0 || n >= 1) && window.clearInterval(o);
          }, 50);
        });
    },
    'g+oV': function(t, e, i) {
            ...
            return (s.rasterizeHTML =
              ...
              (u = (function(t) {
                ...
                return (
                      ...
                      return (
                        i(r, 'open', function(e, i) {
                          var r = e.shift(),
                            s = e.shift(),
                            o = t.joinUrl(n, s);
                          return i.apply(this, [r, o].concat(e));
                        }),
                        r
                      );
                    };
                  ...
                  (e.finishNotifyingXhr = function(t) {
                    ...
                    return (
                      (a.waitForRequestsToFinish = function() {
                        return (s = !0), e(), o;
                      }),
                      a
                    );
              ...
              (c = (function(t) {
                ...
                return (
                  (e.fakeUserAction = function(e, i, r) {
                    ...
                    s &&
                      (n[r]
                        ? t.addClassNameRecursively(s, a)
                        : t.addClassName(s, a),
                      t.rewriteCssSelectorWith(e, o, '.' + a));
                  }),
                    ...
                    r = function(t, r, s) {
                      ...
                      e(t.querySelectorAll('style')).forEach(function(t) {
                        ...
                        var u = e(t.sheet.cssRules).filter(function(t) {
                          return (
                            t.selectorText &&
                            new RegExp(o, 'i').test(t.selectorText)
                          );
                        });
                        u.length &&
                      ...
                      return new Promise(function(r) {
                        ...
                        (s.onload = function() {
                          ...
                          (s.contentWindow.onerror = function(t) {
                            a.push({ resourceType: 'scriptExecution', msg: t });
                          }),
                ...
                (r.calculateDocumentContentSize = function(t, e) {
                  return new Promise(function(i, r) {
                    ...
                    (o = (function(t, e, i) {
                      ...
                      n.document.getElementsByTagName('body')[0].appendChild(o),
                      (o.onload = function() {
                        var l,
                          u = o.contentDocument;
                        try {
                      ...
                      (function(t, e) {
                        ...
                        if (a)
                          for (
                            ...
                            (o = s.attributes[r]),
                              t.documentElement.setAttribute(o.name, o.value);
                      })(e, t),
                      e
                    );
                  });
              ...
              (f = (function(t) {
                ...
                var e,
                  ...
                  l = function(t) {
                    return (void 0 === e && (e = a()), e).then(function(e) {
                      return n(t, e);
                    });
                  };
                return (
                  (i.renderSvg = function(t) {
                    return new Promise(function(e, i) {
                      ...
                      ((s = new Image()).onload = function() {
                        (s.onload = null), (s.onerror = null), o(), e(s);
                      }),
                        (s.onerror = function() {
                          o(), i();
                        }),
              ...
              (p = (function(t, e, i, n) {
                ...
                return (
                  (r.getSvgForDocument = function(t, e, n) {
                    return i.rewriteTagNameSelectorsToLowerCase(t), o(t, e, n);
                  }),
              ...
              (d = (function(t, e, i, n, r, s) {
                ...
                return (
                  (o.rasterize = function(n, r, o) {
                    var a;
                    return (
                      ((a = t.clone(o)).inlineScripts = !0 === o.executeJs),
                      s
                        .inlineReferences(n, a)
                        .then(function(t) {
                          return o.executeJs
                            ? (function(t, n) {
                                return e
                        ...
                        .then(function(t) {
                          return u(t.element, r, o).then(function(e) {
                            return {
                              image: e.image,
                              svg: e.svg,
                              errors: t.errors
              ...
              (function(t, e, i) {
                ...
                n.drawDocument = function() {
                  var e = arguments[0],
                    ...
                    o = e.documentElement ? e.documentElement : e;
                  return i.rasterize(o, s.canvas, r(s));
                };
                ...
                return (
                  (n.drawURL = function() {
                    var e = arguments[0],
                      i = Array.prototype.slice.call(arguments, 1),
                      n = t.parseOptionalParameters(i);
                    return o(e, n.canvas, n.options);
                  }),
                  n
                );
              })(l, h, d)));
            var r, o, a, l, u, c, h, f, p, d;
        ...
        /*! https://mths.be/punycode v1.3.2 by @mathias */ !(function(s) {
              ...
              for (
                ...
                r >= w && C('invalid-input'),
                  ((f =
                    ...
                    C('overflow'),
                  (x += f * o),
                  !(f < (p = a <= P ? c : a >= P + h ? h : a - P));
                a += u
              )
                o > b(l / (g = u - p)) && C('overflow'), (o *= g);
          ...
          function I(t) {
            var e,
              ...
              P,
              k = [];
            for (y = (t = S(t)).length, e = m, i = 0, s = d, o = 0; o < y; ++o)
              (v = t[o]) < 128 && k.push(T(v));
            for (n = r = k.length, r && k.push(_); n < y; ) {
              for (a = l, o = 0; o < y; ++o)
                (v = t[o]) >= e && v < a && (a = v);
              for (
                a - e > b((l - i) / (w = n + 1)) && C('overflow'),
                  i += (a - e) * w,
                  e = a,
                  o = 0;
                o < y;
                    ...
                    (t[s].prototype = {
                      ...
                      _truncateToNode: function(i) {
                        ...
                        if (
                          ...
                          for (var s = 0; s < r.length; s++) {
                            ...
                            var o = this._fits();
                            if ((t(this.opts.ellipsis, r[s]).remove(), !o)) {
                              if ('node' == this.opts.truncate && 1 < s)
                                return void t(r[s - 2]).remove();
                              break;
                            }
                          }
                          for (var a = s; a < n.length; a++) t(n[a]).remove();
                      ...
                      _truncateToWord: function(t) {
                        for (
                          ...
                          if (
                            ((o = s.slice(0, a).join(r)),
                            i.__setTextContent(e, i._addEllipsis(o)),
                            i._fits())
                          ) {
                            'letter' == i.opts.truncate &&
                              (i.__setTextContent(e, s.slice(0, a + 1).join(r)),
      ...
      i.r(e),
        function(t, e) {
          ...
          (window.$ = t),
            ...
            (window.Beep = r.a),
            (window.bindButtonHoverEffect = o.a),
            (window.newsletter = a.a),
          ...
          (window.initPlayVideoButton = function(e, i) {
            ...
            (l.onload = function() {
              i ||
                ...
                a.drawImage(l, 0, 0, 213, 90, 0, 0, 213, 90),
                ...
                t('.l-header__play-button canvas').on('mouseout', function() {
                  (c = !1), o && (clearTimeout(o), (o = null), (h = !1));
                }));
            }),
              (l.src = e);
          }),
        ...
        var n = function() {
          ...
          r
            ...
            n
              ...
              .on('input', function() {
                t(this).val().length
                  ? (t(this).removeClass('empty'), o.hide())
                  : (t(this).addClass('empty'), o.show());
              })
              .addClass('empty'),
    ...
    'z/o8': function(t, e, i) {
       ...
       **/ n.e._gsDefine(
        ...
        function() {
          ...
          var f = function(t, e, i, r) {
            (e = !1 !== e), (i = !1 !== i);
            for (
              var s, o, a = h((r = !1 !== r)), l = e && i && r, u = a.length;
              --u > -1;
      ...
      n.e._gsDefine(
        ...
        function() {
          ...
          var u,
            ...
            q = U('div'),
            X = U('img'),
            V = (s._internals = { _specialProps: a }),
            ...
            et = (V.convertToPixels = function(t, e, i, r, o) {
            ...
            mt = function(t, e) {
              ...
              for (i = 0; i < s.length; i++)
                (n = s[i]),
                  (o +=
                    (r = t.substr(o, t.indexOf(n, o) - o)).length + n.length),
          ...
          var gt = function(t, e, i, n) {
            ...
            wt =
              ...
              (V.CSSPropTween = function(e, i, n, s, o, a, l, u, c, h, f) {
                (this.t = e),
                  (this.p = i),
                  (this.s = n),
                  (this.c = s),
            ...
            bt = (s.parseComplex = function(t, e, i, n, r, o, a, l, c, h) {
              (i = i || o || ''),
                ...
                (a = new wt(t, e, 0, 0, a, h ? 2 : 1, null, !1, l, i, n)),
                (n += ''),
                r &&
                  _t.test(n + i) &&
                  ((n = [i, n]),
              ...
              for (
                ...
                if (
                  ...
                  if (!(b = w.match(v)) || b.length !== x.length) return a;
              ...
              if (!a[t]) {
                ...
                Pt(t, {
                  parser: function(t, i, n, r, s, l, u) {
                    ...
                    return c
                      ? (c._cssRegister(), a[n].parse(t, i, n, r, s, l, u))
              ...
              if (
                ...
                Mt &&
                  ...
                  ((l = t.parentNode) && t.offsetParent) ||
                    ((o = 1), (a = t.nextSibling), Bt.appendChild(t)),
                  (i =
                    !(n = tt(t, Dt, null, !0)) ||
                    'none' === n ||
              ...
              if (
                ...
                if (16 === o.length) {
                  var _,
                    ...
                    F = Math.atan2(S, E);
                  f.zOrigin &&
                    ((I = R * (D = -f.zOrigin) - o[12]),
                    (M = A * D - o[13]),
                    (D = E * D + f.zOrigin - o[14])),
                    (f.rotationX = F * N),
                    F &&
          ...
          ((l =
            ...
            (l._onInitTween = function(n, o, l, f) {
              ...
              if (
                ...
                'string' == typeof o &&
                  ...
                  (k.cssText = y + ';' + o),
                  (d = rt(n, d, nt(n)).difs),
                  !Y && C.test(o) && (d.opacity = parseFloat(RegExp.$1)),
                  (o = d),
                  (k.cssText = y)),
                o.className
                    ...
                    (v && k.test(p))
                      ? (v ||
                          (p =
                            ...
                            p.join(',') +
                            ')'),
                        (r = bt(w, o, f, p, !0, 'transparent', r, 0, s)))
                      : v && z.test(p)
                      ? (r = bt(w, o, f, p, !0, null, r, 0, s))
                      : ((d =
                          (c = parseFloat(f)) || 0 === c
                            ? f.substr((c + '').length)
                            : ''),
          ...
          function() {
            ...
            return (
              ...
              (d.fromTo = function(t, e, i, r, s) {
                var o = (r.repeat && l.TweenMax) || n.f;
                return (
                  (r = f(0, r, i)),
                  e ? this.add(o.fromTo(t, e, i, r), s) : this.set(t, r, s)
                );
              }),
              (d.staggerTo = function(e, i, s, o, a, l, h, f) {
                var d,
                  m,
                  _ = new t({
                    onComplete: l,
              ...
              (d.staggerFrom = function(t, e, i, n, r, s, o, a) {
                return (
                  (i.runBackwards = !0),
                  this.staggerTo(t, e, f(0, i), n, r, s, o, a)
                );
              }),
              (d.staggerFromTo = function(t, e, i, n, r, s, o, a, l) {
                return (
                  (n.startAt = i),
                  this.staggerTo(t, e, f(0, n, i), r, s, o, a, l)
                );
              }),
              ...
              (t.exportRoot = function(e, i) {
                ...
                for (
                  ...
                  (a = o._next),
                    (i && o instanceof n.f && o.target === o.vars.onComplete) ||
                      ((s = o._startTime - o._delay) < 0 && (r = 1),
                      l.add(o, s)),
                    (o = a);
              ...
              (d.add = function(e, i, r, o) {
                ...
                if (
                  ...
                  if (e instanceof Array || (e && e.push && s(e))) {
                    for (
                      r = r || 'normal', o = o || 0, a = i, l = e.length, u = 0;
                      u < l;
                      u++
                    )
                ...
                for (var s = [], o = this._first, a = 0; o; )
                  o._startTime < r ||
                    (o instanceof n.f
                      ...
                      : (!1 !== i && (s[a++] = o),
                        !1 !== t &&
                          (a = (s = s.concat(o.getChildren(!0, e, i)))
                            .length))),
                    (o = o._next);
                return s;
              }),
              ...
              (d.totalDuration = function(t) {
                if (!arguments.length) {
                  if (this._dirty) {
                    for (
                      var e, i, n = 0, r = this, s = r._last, o = 999999999999;
                      s;
              ...
              if ((this._time !== d && this._first) || n || u || h) {
                if (
                  ...
                  for (
                    s = this._first;
                    s &&
                    ((a = s._next), f === this._time && (!this._paused || x));
                  ...
                  for (
                    s = this._last;
                    s &&
                    ((a = s._prev), f === this._time && (!this._paused || x));
      ...
      var p = n.g.TimelineMax,
            ...
            (o = (u = t[T]).a),
              ...
              r
                ? ((v = m[s]),
                  ...
                  (f =
                    a -
                    ((c = a - (a - o) * (n ? 0.5 * e : 0 !== v ? w / v : 0)) +
                      ((((h =
                        a + (l - a) * (n ? 0.5 * e : 0 !== y ? w / y : 0)) -
                        c) *
                        ((3 * v) / (v + y) + 0.5)) /
                        4 || 0))))
                : (f =
        ...
        C = function(t, e, i, n, r, s) {
          ...
          t[0]))
            y.push(a);
          if (t.length > 1) {
            for (p = t[t.length - 1], f = !0, o = y.length; --o > -1; )
              if (((a = y[o]), Math.abs(w[a] - p[a]) > 0.05)) {
                f = !1;
                break;
              }
            f &&
          ...
          for (m.length = _.length = g.length = 0, o = y.length; --o > -1; )
            (a = y[o]),
              (v[a] = -1 !== r.indexOf(',' + a + ',')),
              (d[a] = T(t, a, v[a], s));
          for (o = m.length; --o > -1; )
            (m[o] = Math.sqrt(m[o])), (_[o] = Math.sqrt(_[o]));
          if (!n) {
            for (o = y.length; --o > -1; )
              if (v[a])
                for (h = (l = d[y[o]]).length - 1, u = 0; u < h; u++)
                  (c = l[u + 1].da / _[u] + l[u].da / m[u] || 0),
                    (g[u] = (g[u] || 0) + c * c);
            for (o = g.length; --o > -1; ) g[o] = Math.sqrt(g[o]);
          }
          for (o = y.length, u = i ? 4 : 1; --o > -1; )
            (l = d[(a = y[o])]),
              b(l, e, i, n, v[a]),
      ...
      var O = n.g.Back,
        ...
        F = n.g.Sine,
        N = n.g.ExpoScaleEase;
      (r._autoActivated = [f, p, s, o, k, a, h, O, R, A, E, I, M, D, z, F, N]),
        i.d(e, 'a', function() {
          return n.f;
        });
    }
